...
OPTI := -g2
FLAGS := -std=c++2a  $(OPTI) -pthread -rdynamic
...
FLAGS += -fsanitize=address -fsanitize=pointer-subtract -fsanitize=pointer-compare -fsanitize=leak -fsanitize=undefined -fuse-ld=gold
